...
from filters.observation.observation_move_axis_filter import ObservationMoveAxisFilter
...
from spaces import BoxActionSpace, VectorObservationSpace, PlanarMapsObservationSpace, StateSpace, CompoundActionSpace, \
    DiscreteActionSpace
...
class StarCraft2EnvironmentParameters(EnvironmentParameters):
    ...
    @property
    def path(self):
        return 'environments.starcraft2_environment:StarCraft2Environment'
...
class StarCraft2Environment(Environment):
    def __init__(self, level: LevelSelection, frame_skip: int, visualization_parameters: VisualizationParameters,
        ...
        feature_minimap: [height_map, visibility_map, creep, camera, player_id, player_relative, selected]

...
from dashboard_components.globals import layouts, crcolor, crx, cry, color_resolution, crRGBs
from dashboard_components.experiment_board import file_selection_button, files_selector_spacer, group_selection_button, \
                                                  unload_file_button, files_selector

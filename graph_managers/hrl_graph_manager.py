...
from base_parameters import AgentParameters, VisualizationParameters, TaskParameters, TestingParameters
...
class HRLGraphManager(GraphManager):
    ...
    def __init__(self, agents_params: List[AgentParameters], env_params: EnvironmentParameters,
        ...
        test_params: TestingParameters = TestingParameters()):
        """
    ...
    def _create_graph(self, task_parameters: TaskParameters) -> Tuple[List[LevelManager], List[Environment]]:
        ...
        for level_idx, agent_params in reversed(list(enumerate(self.agents_params))):
            ...
            # else:
            #     pass
                # TODO: this is very specific for HRL on observation scale
            ...
            level_manager = LevelManager(
                ...
                reset_after_every_acting_phase=level_idx > 0,

...
from core_types import TrainingSteps, EnvironmentSteps, RunPhase
from environments.doom_environment import DoomEnvironmentParameters, DoomEnvironment
...
schedule_params.steps_between_evaluation_periods = EnvironmentSteps(500000)
schedule_params.evaluation_steps = EnvironmentSteps(50000)
...
# training steps. i.e. it is equivalent to once every 64 playing steps (when a training batch is sampled).
# so this is 1.5M*64 =~ 100M playing steps.
# TODO allow the epsilon schedule to be defined in terms of training steps.
agent_params.exploration.epsilon_schedule = LinearSchedule(1, 0, 100000000)

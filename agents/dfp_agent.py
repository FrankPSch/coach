...
from architectures.tensorflow_components.heads.measurements_prediction_head import MeasurementsPredictionHeadParameters
...
from core_types import ActionInfo, EnvironmentSteps, RunPhase
...
from spaces import SpacesDefinition, VectorObservationSpace
...
class DFPAlgorithmParameters(AlgorithmParameters):
    def __init__(self):
        ...
        self.num_consecutive_playing_steps = EnvironmentSteps(64)
...
class DFPAgent(Agent):
    ...
    def learn_from_batch(self, batch):
        ...
        network_inputs['goal'] = batch.goals()

...
from configurations import AgentParameters, VisualizationParameters, unfold_dict_or_list
...
class BasicRLFactory(BlockFactory):
    """
    ...
    def _create_block(self, task_parameters: TaskParameters) -> BlockScheduler:
        ...
        block_scheduler = BlockScheduler(
            name='simple_rl_block',
            level_managers=[level_manager],
            environments=[env],
            task_parameters=task_parameters,
            **self.schedule_params.__dict__
        )

...
from base_parameters import AgentParameters, InputEmbedderParameters, EmbeddingMergerType
...
class GeneralTensorFlowNetwork(TensorFlowArchitecture):
    ...
    def get_input_embedder(self, input_name: str, embedder_params: InputEmbedderParameters):
        ...
        embedder_params_copy.input_normalization = embedder_params_copy.input_normalization[type]
    ...
    def get_model(self):
        ...
        for network_idx in range(self.num_networks):
            with tf.variable_scope('network_{}'.format(network_idx)):
                ...
                state_embedding = []
                for input_name, input_type in self.network_parameters.input_embedders_parameters.items():
